...
class WysiwygFieldType extends FieldType
{
    ...
    const ALLOWED_TOOLBAR           = ['|', 'bold', 'italic', 'link', 'bulletedList', 'numberedList', 'blockQuote', 'alignment', 'insertTable', 'tableColumn', 'mergeTableCells', 'tableRow', 'highlight', 'mediaEmbed'];
        ...
        if(!empty($heading)) {
            $heading = array_map(function($option){
                ...
                if(is_array($option)) {
                    ...
                    // All custom headings must be converted before standard headings.
                    $heading_option['converterPriority'] = 'high';
