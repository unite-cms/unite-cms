...
class ViewParameterBagTest extends TestCase
{
    ...
    public function testGetterAndSetter() {
        ...
        $this->assertEquals('any_create_pattern', $bag->setCreateUrlPattern('any_create_pattern')->getCreateUrlPattern());
        $this->assertEquals('any_delete_pattern', $bag->setDeleteUrlPattern('any_delete_pattern')->getDeleteUrlPattern());
        $this->assertEquals('any_recover_pattern', $bag->setRecoverUrlPattern('any_recover_pattern')->getRecoverUrlPattern());
        $this->assertEquals('any_delete_definitely_pattern', $bag->setDeleteDefinitelyUrlPattern('any_delete_definitely_pattern')->getDeleteDefinitelyUrlPattern());
        $this->assertEquals('any_translations_pattern', $bag->setTranslationsUrlPattern('any_translations_pattern')->getTranslationsUrlPattern());
        $this->assertEquals('any_revisions_pattern', $bag->setRevisionsUrlPattern('any_revisions_pattern')->getRevisionsUrlPattern());
    ...
    public function testCreateFromView() {
        ...
        ]), json_encode(ViewParameterBag::createFromView(
            $view,
            $generator,
