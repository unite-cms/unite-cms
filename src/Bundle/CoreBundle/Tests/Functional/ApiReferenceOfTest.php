...
class ApiReferenceOfTest extends APITestCase
{
    ...
    public function setUp()
    {
        ...
        $domainMember1->setDomainMemberType($this->domains['domain1']->getDomainMemberTypes()->first());
        ...
        $domainMember2->setDomainMemberType($this->domains['domain2']->getDomainMemberTypes()->first());
