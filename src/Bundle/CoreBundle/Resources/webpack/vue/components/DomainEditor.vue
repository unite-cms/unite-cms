<template>
    <div>
        <textarea v-if="!is_disabled" :name="field_name" v-model="definition"></textarea>
        <div v-if="!is_disabled" uk-height-viewport offset-top="true" :id="editor_id"></div>
        <input type="hidden" v-if="is_disabled" :name="field_name" v-model="definition" />
    </div>
</template>
